            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('ads.show', $ad) }}" class="stretched-link mt-auto align-self-start">Посмотреть объявление</a>
                    </div>
                </div>
            </div>
        @endforeach
...
@else
    <div class="alert alert-info">Вы ещё не создали ни одного объявления. <a href="{{ route('ads.create') }}" class="alert-link">Добавить объявление</a></div>
@endif
@endsection
